...
contract DistributorUsageFeesTest is Test {
    ...
    function setUp() public {
        ...
        buildNFT.setOwner(1, alice);
        buildNFT.setOwner(2, bob);
        buildNFT.setOwner(3, carol);
    ...
    function testAccrueSplitsByCountsAndTracksUniqueUsers() public {
        ...
        uint256 share1 = (value * 32) / 50;
        uint256 share2 = (value * 10) / 50;
    ...
    function testSelfPayBlockedGoesToProtocolTreasury() public {
        ...
        uint256 share1 = (value * 3) / 4;
        uint256 share2 = value - share1;

        assertEq(distributor.ethOwed(alice), 0);
        assertEq(distributor.ethOwed(protocolTreasury), share1);
        assertEq(distributor.ethOwed(bob), share2);
        assertEq(distributor.uniqueUsers(1), 1);
    }
